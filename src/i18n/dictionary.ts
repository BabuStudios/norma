...
const sv = {
  ...
  arrowColorLabel: 'Pilfärg',
  backgroundColorLabel: 'Bakgrundsfärg',
  boxColorLabel: 'Lådfärg',
  ...
  orgChartTopLabel: 'VD',
  orgChartProductionLabel: 'Produktionschef',
  orgChartSalesLabel: 'Försäljningschef',
  orgChartPurchasingLabel: 'Inköpschef',
  orgChartFinanceHrLabel: 'Ekonomi- och HR-chef',
  boxLabel: 'Låda',
...
const en: Dictionary = {
  ...
  orgChartTopLabel: 'CEO',
  orgChartProductionLabel: 'Production manager',
  orgChartSalesLabel: 'Sales manager',
  orgChartPurchasingLabel: 'Purchasing manager',
  orgChartFinanceHrLabel: 'Finance & HR manager',
  boxLabel: 'Box',
